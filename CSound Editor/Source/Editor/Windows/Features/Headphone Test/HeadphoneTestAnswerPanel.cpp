#include "HeadphoneTestAnswerPanel.h"
...
HeadphoneTestAnswerPanel::HeadphoneTestAnswerPanel()
{
...
void HeadphoneTestAnswerPanel::InitUI()
{
...
void HeadphoneTestAnswerPanel::SetupAnswerPanel(vector<float> azimuthSamples, vector<float> elevationSamples)
{
	if (generatedPanel) {
...
void HeadphoneTestAnswerPanel::OnButtonClick(CallbackFunc onClick)
{
	callbacks.push_back(onClick);
}

void HeadphoneTestAnswerPanel::ButtonClick(unsigned int index)
{
